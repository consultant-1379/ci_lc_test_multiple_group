...
/**
 * Audits the EBM subscription to ensure that all expected scanners are present in DPS
 */
@Singleton
@Lock(LockType.READ)
public class EbmSubscriptionAuditor implements SubscriptionAuditor {
    ...
    public List<Long> getActiveSubscriptionIds() {
        return resourceSubscriptionHelper.getActiveSubscriptionIds(SubscriptionType.EBM);
    }
}
