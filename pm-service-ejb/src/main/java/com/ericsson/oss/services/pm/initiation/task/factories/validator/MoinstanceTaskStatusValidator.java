...
/**
 * This class validates the Task status for the MoinstanceSubscription
 */
@SubscriptionTaskStatusValidation(subscriptionType = MoinstanceSubscription.class)
@ApplicationScoped
public class MoinstanceTaskStatusValidator extends StatisticalTaskStatusValidator {
