...
/**
 * Audits the CellRelation subscriptions to ensure that all expected scanners are present in DPS. This auditor will not correct missing/duplicate
 * node. It will just call Task Validator.
 */
@Singleton
@Lock(LockType.READ)
public class CellRelationSubscriptionAuditor implements SubscriptionAuditor {
    @Inject
    ...
    public List<Long> getActiveSubscriptionIds() {
       return resourceSubscriptionHelper.getActiveSubscriptionIds(SubscriptionType.CELLRELATION);
    }
}
