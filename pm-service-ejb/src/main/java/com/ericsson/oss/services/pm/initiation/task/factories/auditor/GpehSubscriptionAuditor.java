...
/**
 * Audits the GPEH subscriptions to ensure that all expected scanners are present in DPS
 */
@Singleton
@Lock(LockType.READ)
public class GpehSubscriptionAuditor implements SubscriptionAuditor {
    ...
    public List<Long> getActiveSubscriptionIds() {
        return resourceSubscriptionHelper.getActiveSubscriptionIds(SubscriptionType.GPEH);
    }
}
