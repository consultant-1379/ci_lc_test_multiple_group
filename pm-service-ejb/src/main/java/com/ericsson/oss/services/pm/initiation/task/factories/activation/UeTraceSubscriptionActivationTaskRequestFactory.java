...
/**
 * The Ue trace subscription activation task request factory.
 */
@ActivationTaskRequest(subscriptionType = UETraceSubscription.class)
@ApplicationScoped
public class UeTraceSubscriptionActivationTaskRequestFactory extends AbstractSubscriptionTaskRequestFactory
    ...
    public List<MediationTaskRequest> createMediationTaskRequests(final List<Node> nodes, final UETraceSubscription subscription,
        ...
        pmJobSynchronizer.syncAllPmJobsInDPSForSubscription(subscription.getId(), ropPeriodInSec, nodesFdnsToActivate.keySet(), ProcessType.UETRACE);
