...
/**
 * The RTT subscription deactivation task request factory.
 */
@DeactivationTaskRequest(subscriptionType = RttSubscription.class)
@ApplicationScoped
public class RttSubscriptionDeactivationTaskRequestFactory extends AbstractSubscriptionTaskRequestFactory
    ...
    public List<MediationTaskRequest> createMediationTaskRequests(final List<Node> nodes, final RttSubscription subscription,
        ...
        logger.debug("Deactivating RTT Subscription {}", subscription.getName());
