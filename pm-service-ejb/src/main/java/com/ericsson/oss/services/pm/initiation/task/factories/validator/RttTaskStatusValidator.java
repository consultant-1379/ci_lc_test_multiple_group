...
/**
 * The RTT task status validator.
 */
@SubscriptionTaskStatusValidation(subscriptionType = RttSubscription.class)
@ApplicationScoped
public class RttTaskStatusValidator extends ResourceTaskStatusValidator {
}
