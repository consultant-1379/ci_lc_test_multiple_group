...
/**
 * Deactivation task request factory for Ctum
 */
@DeactivationTaskRequest(subscriptionType = CtumSubscription.class)
@ApplicationScoped
public class CtumSubscriptionDeactivationTaskRequestFactory extends AbstractSubscriptionTaskRequestFactory
    ...
    /**
     * This method is to build Ctum deactivation tasks for all nodes in a subscription.
     *
     * @param nodes
    ...
    public List<MediationTaskRequest> createMediationTaskRequests(final List<Node> nodes, final CtumSubscription subscription,
        ...
        pmJobSynchronizer.syncAllPmJobsInDPSForSubscription(subscription.getId(), ropPeriodInSec, nodesFdnsToDeactivate.keySet(), ProcessType.CTUM);
