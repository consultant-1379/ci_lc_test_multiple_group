...
/**
 * The type Pm events look up for non trigger cell traffic events.
 */
public class PmCellTrafficNonTriggerEventsLookUp extends AbstractPmEventsLookUp {
    ...
    protected Collection<EventTableRow> fetchEventsAndGroups(final ModelInfo modelInfo) {
        return getProfileEvents(modelInfo, PmMetaDataConstants.CELL_TRAFFIC_PROFILE_PATTERN, EventTypeFilter.NON_TRIGGERED);
    }
