...
/**
 * This class validates the Task status for the GpehSubscription
 */
@SubscriptionTaskStatusValidation(subscriptionType = GpehSubscription.class)
@ApplicationScoped
public class GpehTaskStatusValidator extends ResourceTaskStatusValidator {
