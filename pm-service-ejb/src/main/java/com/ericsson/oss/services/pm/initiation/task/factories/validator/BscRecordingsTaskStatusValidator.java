...
/**
 * The BscRecordings task status validator.
 */
@SubscriptionTaskStatusValidation(subscriptionType = BscRecordingsSubscription.class)
@ApplicationScoped
public class BscRecordingsTaskStatusValidator extends ResourceTaskStatusValidator {
