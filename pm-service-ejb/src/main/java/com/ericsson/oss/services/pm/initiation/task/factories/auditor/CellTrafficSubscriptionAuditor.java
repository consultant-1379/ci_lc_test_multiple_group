...
/**
 * Audits the CELLTRAFFIC subscriptions to ensure that all expected scanners are present in DPS
 */
@Singleton
@Lock(LockType.READ)
public class CellTrafficSubscriptionAuditor implements SubscriptionAuditor {
    ...
    public List<Long> getActiveSubscriptionIds() {
        return resourceSubscriptionHelper.getActiveSubscriptionIds(SubscriptionType.CELLTRAFFIC);
    }
}
