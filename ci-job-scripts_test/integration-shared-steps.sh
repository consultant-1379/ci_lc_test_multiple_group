...
[ ! -z "$SETUP_TASKS_FILE" -a -f "$SETUP_TASKS_FILE" ] && groovy $SCRIPTS_FOLDER/download_rpms.groovy
[ ! -z "$SETUP_TASKS_FILE" -a -f "$SETUP_TASKS_FILE" ] && $SCRIPTS_FOLDER/docker-env-setup.sh $IT_FOLDER
[ ! -z "$SETUP_TASKS_FILE" -a -f "$SETUP_TASKS_FILE" ] && groovy $SCRIPTS_FOLDER/inspect_review.groovy
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
