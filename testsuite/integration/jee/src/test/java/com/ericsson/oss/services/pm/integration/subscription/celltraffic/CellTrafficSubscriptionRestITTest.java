...
package com.ericsson.oss.services.pm.integration.subscription.celltraffic;
...
public class CellTrafficSubscriptionRestITTest extends BaseSubscriptionRest {
    private static final String INPUT_NODE_JSON_FILE = "CellTrafficSubscription/CellTrafficSubscriptionNodes.json";
    private static final String BASIC_CELLTRAFFIC_SUBSCRIPTION_JSON_FILE = "CellTrafficSubscription/CellTrafficSubscription.json";
    ...
    public void testUetrSubscription() throws Exception {
        testSubscription(BASIC_CELLTRAFFIC_SUBSCRIPTION_JSON_FILE, CellTrafficSubscription.class,
                com.ericsson.oss.pmic.dto.subscription.CellTrafficSubscription.class, true);
    }
