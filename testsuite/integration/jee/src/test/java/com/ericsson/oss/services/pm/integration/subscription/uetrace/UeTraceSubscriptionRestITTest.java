...
package com.ericsson.oss.services.pm.integration.subscription.uetrace;
...
public class UeTraceSubscriptionRestITTest extends BaseSubscriptionRest {
    private static final String INPUT_NODE_JSON_FILE = "UETraceSubscription/UETraceSubscriptionNodes.json";
    private static final String BASIC_UETRACE_SUBSCRIPTION_JSON_FILE = "UETraceSubscription/UETraceSubscription.json";
    ...
    @InSequence(3)
    @OperateOnDeployment(PM_SERVICE_TEST)
    public void testUeTraceSubscription() throws Exception {
        testSubscription(BASIC_UETRACE_SUBSCRIPTION_JSON_FILE, UETraceSubscription.class,
                com.ericsson.oss.pmic.dto.subscription.UETraceSubscription.class, true);
    }
