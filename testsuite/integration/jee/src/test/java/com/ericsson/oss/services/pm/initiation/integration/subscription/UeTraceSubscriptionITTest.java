...
public class UeTraceSubscriptionITTest extends InputBaseArquillian {

    Logger logger = LoggerFactory.getLogger(UeTraceSubscriptionITTest.class);
    ...
    public void createUeTraceSubscription() throws InterruptedException {
        ...
        final SubscriptionOperationRequest createMessage = new SubscriptionOperationRequest(PmServiceRequestsTypes.CREATE_UE, null, null, getClass()
                .getSimpleName());
