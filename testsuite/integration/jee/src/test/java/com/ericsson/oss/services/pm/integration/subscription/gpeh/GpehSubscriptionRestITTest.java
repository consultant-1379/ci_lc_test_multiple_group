...
package com.ericsson.oss.services.pm.integration.subscription.gpeh;
...
public class GpehSubscriptionRestITTest extends BaseSubscriptionRest {
    private static final String INPUT_NODE_JSON_FILE = "GpehSubscription/GpehSubscriptionNodes.json";
    private static final String BASIC_GPEH_SUBSCRIPTION_JSON_FILE = "GpehSubscription/GpehSubscription.json";
    ...
    @InSequence(3)
    @OperateOnDeployment(PM_SERVICE_TEST)
    public void testGpehSubscription() throws Exception {
        testSubscription(BASIC_GPEH_SUBSCRIPTION_JSON_FILE, GpehSubscription.class,
                com.ericsson.oss.pmic.dto.subscription.GpehSubscription.class, true);
    }
